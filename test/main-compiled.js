...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_dev_widget_hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/dev/widget-hooks */ \"./src/dev/widget-hooks.js\");\n/* harmony import */ var _src_dev_widget_hooks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_dev_widget_hooks__WEBPACK_IMPORTED_MODULE_0__);\n\n\nlet now = function(){\n    return (new Date()).getMilliseconds() + ': ';\n};\n\n_src_dev_widget_hooks__WEBPACK_IMPORTED_MODULE_0___default.a.register('test', function (elem) {\n    let str = now() + 'test1 execution';\n    elem.innerHTML += '<br/>' + str;\n    console.log(str);\n}, 5);\n\n\n_src_dev_widget_hooks__WEBPACK_IMPORTED_MODULE_0___default.a.register('test2', function (elem) {\n    let str = now() + 'test2 execution';\n    elem.innerHTML += '<br/>' + str;\n    console.log(str);\n}, 1);\n\n\n_src_dev_widget_hooks__WEBPACK_IMPORTED_MODULE_0___default.a.init();\n\n//# sourceURL=webpack:///./test/main.js?");
